...
public class MainActivity extends AppCompatActivity {
    ...
    // App ID
    private String appId = "a8238e4cde1d4d979d0fb32983c2a757";
    // 频道名
    private String channelName = "julys";
    ...
    private void initializeAndJoinChannel() {
        ...
        mRtcEngine.setVideoEncoderConfiguration(new VideoEncoderConfiguration(
                ...
                6400,VideoEncoderConfiguration.ORIENTATION_MODE.ORIENTATION_MODE_ADAPTIVE
        ));
    }
    ...
    public String run(String channelName) throws Exception {
        Request request = new Request.Builder()
                .url("http://8.146.211.151:8080/rtcToken?channelName="+channelName)
                .build();
